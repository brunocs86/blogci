!function (t, e) {
	...
	var e = "SweetAlert2:", w = function (t) {
		...
		P = t(["success", "warning", "info", "question", "error"]), S = {previousBodyPadding: null};
	...
	function ot(t, e) {
		var n = Q(), o = K(), i = Z();
		if (!e.showConfirmButton && !e.showCancelButton) return O(n);
		y(n, e.customClass, "actions"), pt(o, "confirm", e), pt(i, "cancel", e), e.buttonsStyling ? function (t, e, n) {
		...
		lt = function (t) {
			if (function () {
				...
				n.appendChild(e), function (t) {
					...
					var t = _(), e = st(t, x.input), n = st(t, x.file),
	...
	Ct.text = Ct.email = Ct.password = Ct.number = Ct.tel = Ct.url = function (t) {
		...
		var e = st(_(), x.range), n = e.querySelector("input"), o = e.querySelector("output");
		...
		var e = st(_(), x.checkbox), n = B(_(), "checkbox");
	...
	function kt(t, e) {
		...
		e.html ? (nt(e.html, n), L(n, "block")) : e.text ? (n.textContent = e.text, L(n, "block")) : O(n), function (t, o) {
			var i = _(), e = ht.innerParams.get(t), r = !e || o.input !== e.input;
	...
	function Pt(t, e) {
		...
		y(n, e.customClass, "header"), xt(0, e), function (t, e) {
			...
			if (n && e.type === n.type && N()) y(N(), e.customClass, "icon"); else if (At(), e.type) if (Et(), -1 !== Object.keys(P).indexOf(e.type)) {
	...
	function St(t, e) {
		...
		}(0, e), mt(0, e), Pt(t, e), kt(t, e), ot(0, e), function (t, e) {
			var n = $();
	...
	function Kt(t, e, n, o) {
		n ? $t(t, o) : (Lt().then(function () {
			return $t(t, o)
		}), Ht.keydownTarget.removeEventListener("keydown", Ht.keydownHandler, {capture: Ht.keydownListenerCapture}), Ht.keydownHandlerAdded = !1), e.parentNode && e.parentNode.removeChild(e), G() && (null !== S.previousBodyPadding && (document.body.style.paddingRight = S.previousBodyPadding + "px", S.previousBodyPadding = null), function () {
		...
		if (e && !b(e, x.hide)) {
			...
			if (n) {
				...
				at(e, x.show), rt(e, x.hide), function (t, e, n) {
					var o = j(), i = ft && H(e), r = n.onClose, a = n.onAfterClose;
	...
	var de = function (t, e) {
		...
		}, Pe = ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"], Se = ["Escape", "Esc"],
		Be = function (t, e, n, o) {
	...
	var De, Ne = Object.freeze({
		hideLoading: Nt, disableLoading: Nt, getInput: function (t) {
			...
			return St(this, e), ht.innerParams.set(this, e), function (n, o, i) {
				return new Promise(function (t) {
					var e = function t(e) {
	...
	}), Ue.DismissReason = k, Ue.version = "8.15.1";
	var _e = Ue;
