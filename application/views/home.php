		...
		<div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				...
				<div class="carousel-item active">
					<div class="carousel-background"><img src="<?php echo base_url(); ?>public/img/intro-carousel/1.jpg"
														  alt=""></div>
				...
				<div class="carousel-item">
					<div class="carousel-background"><img src="<?php echo base_url(); ?>public/img/intro-carousel/2.jpg"
														  alt=""></div>
					<div class="carousel-container">
						<div class="carousel-content">
				...
				<div class="carousel-item">
					<div class="carousel-background"><img src="<?php echo base_url(); ?>public/img/intro-carousel/3.jpg"
														  alt=""></div>
					<div class="carousel-container">
						<div class="carousel-content">
				...
				<div class="carousel-item">
					<div class="carousel-background"><img src="<?php echo base_url(); ?>public/img/intro-carousel/4.jpg"
														  alt=""></div>
					<div class="carousel-container">
						<div class="carousel-content">
							...
							<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci
								...
								aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum.</p>
							<a href="#featured-services" class="btn-get-started scrollto">Get Started</a>
						</div>
					</div>
				</div>
				...
				<div class="carousel-item">
					<div class="carousel-background"><img src="<?php echo base_url(); ?>public/img/intro-carousel/5.jpg"
														  alt=""></div>
					<div class="carousel-container">
						<div class="carousel-content">
					...
					foreach ($courses as $course) { ?>
						...
						<div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
							<div class="portfolio-wrap">
								<figure>
									<img src="<?= base_url() . $course["course_img"]; ?>" class="img-fluid" alt="">
									<a href="<?= base_url() . $course["course_img"]; ?>" data-lightbox="portfolio"
									   data-title="<?= $course["course_name"]; ?>" class="link-preview" title="Preview"><i
								...
								<div class="portfolio-info">
									<h4><a href="#" data-toggle="modal"
										   data-target="#course_<?= $course["course_id"]; ?>"><?= $course["course_name"]; ?></a>
									</h4>
								</div>
							</div>
						</div>
						...
						<!-- Modal Courses -->
						<div class="modal fade" id="course_<?= $course["course_id"]; ?>">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">

									<div class="card text-white bg-dark">
										<img src="<?= base_url() . $course["course_img"]; ?>" class="card-img-top"
											 alt="">

										<div class="card-img-overlay">
											<button type="button" class="btn btn-primary">
												Duração: <span
													class="badge badge-light"><?= intval($course["course_duration"]); ?> </span>
												(H)
											</button>
										</div>
	...
	<section id="team">
		<div class="container">
			<div class="section-header wow fadeInUp">
				<h3>Equipe</h3>
				<p>Nossa equipe é composta de especialista em desenvolvimento web</p>
			</div>
				...
				<?php if (!empty($team)) {
					foreach ($team as $member) { ?>
						<div class="col-lg-3 col-md-6 wow fadeInUp">
							<div class="member">
								<img src="<?php echo base_url() . $member["member_photo"]; ?>" class="img-fluid" alt="">
								<div class="member-info">
									<div class="member-info-content">
										<h4><?= $member["member_name"]; ?></h4>
										<span><?= $member["member_description"]; ?></span>
										<div class="social">
